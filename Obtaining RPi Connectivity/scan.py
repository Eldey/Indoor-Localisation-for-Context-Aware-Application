...
def get_frequency(cell):
    m = matching_line(cell,"Frequency:")
    m1 = m[0:-12]
    return m1
...
columns=["Name","Address","Signal","Quality", "Channel","Frequency", "Encryption"]
...
def main():
	...
	names.append(get_name(cell))
        macs.append(get_address(cell))
        strengths.append(get_signal_level(cell)[:-4])
